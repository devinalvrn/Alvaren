...
from Alvaren import CMD_HELP, StartTime
...
from Alvaren.helpers.tools import convert_to_image
from Alvaren.utils import get_readable_time
from Alvaren.utils.misc import restart

from .help import add_command_help

modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph/file/884b30494a3bb02f40eb4.jpg"
)
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**[Alvaren🇮🇩](https://github.com/devinalvrn/Alvaren) is Up and Running.**\n\n"
        f"<b>{alive_text}</b>\n\n"
