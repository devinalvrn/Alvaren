...
from Alvaren.helpers.constants import MEMES
...
async def gagahkah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "What The F",
        "What The F Brah",
        "[𝗪𝗵𝗮𝘁 𝗧𝗵𝗲 𝗙 𝗕𝗿𝗮𝗵](https://telegra.ph/file/bfeaee5bd137534dedc7e.jpg)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("8===✊D💦💦💦💦💦💦💦💦💦")
    await e.edit("8==✊=D💦💦💦💦💦💦💦💦💦💦")
    await e.edit("8=✊==D Bro nguyung opmem?")
    await e.edit("Subscribe channel dibio 🗿")
...
async def adadino(client: Client, message: Message):
    typew = await edit_or_reply(message, "`YUNG YUNG....`")
    await asyncio.sleep(1)
    await typew.edit("`NGUYUNGGGGGG!!`")
    await asyncio.sleep(1)
    await typew.edit("`🏃                        🦖`")
    await typew.edit("`🏃                       🦖`")
    await typew.edit("`🏃                      🦖`")
    ...
    await typew.edit("`🏃            🦖`")
    await typew.edit("`🏃           🦖`")
    await typew.edit("`🏃WOARGH AMPUN NGUYUNG!   🦖`")
    await typew.edit("`🏃           🦖`")
    await typew.edit("`🏃            🦖`")
    await typew.edit("`🏃             🦖`")
    await typew.edit("`🏃              🦖`")
    ...
    await typew.edit("`🏃          🦖`")
    await typew.edit("`🏃         🦖`")
    await typew.edit("`NGUYUNG SEMAKIN MENDEKAT!!!`")
    await asyncio.sleep(1)
    await typew.edit("`🏃       🦖`")
    await typew.edit("`🏃      🦖`")
    await typew.edit("`🏃     🦖`")
    await typew.edit("`🏃    🦖`")
    await typew.edit("`Dahlah Pasrah Aja Dibantai Nguyung`")
    await asyncio.sleep(1)
    await typew.edit("`🧎🦖`")
    await asyncio.sleep(2)
    await typew.edit("`-NGUYUNG OPMEM BANGET-`")


@Client.on_message(filters.command(["sayang", "syg"], cmd) & filters.me)
async def zeyenk(client: Client, message: Message):
    e = await edit_or_reply(message, "I LOVEE YOUUU NGUYUNG💕")
    await e.edit("💝💘💓💗")
    await e.edit("💞💕💗💘")
    await e.edit("💝💘💓💗")
    await e.edit("💞💕💗💘")
    await e.edit("💘💞💗💕")
    await e.edit("💘💞💕💗")
    await e.edit("SAYANG NGUYUNG 💝💖💘")
    await e.edit("💝💘💓💗")
    await e.edit("💞💕💗💘")
    await e.edit("💘💞💕💗")
    await e.edit("SAYANG NGUYUNG DAN VAREN")
    await e.edit("KAMU SUKA NGUYUNG")
    await e.edit("SELAMANYA VAREN 💕")
    await e.edit("💘💘💘💘")
    await e.edit("SAYANG NGUYUNG")
    await e.edit("KAMU")
    await e.edit("SAYANG NGUYUNG")
    await e.edit("KAMU")
    await e.edit("I LOVE YOU NGUYUNG")
    await e.edit("MY BABY NGUYUNG")
    await e.edit("💕💞💘💝")
    await e.edit("💘💕💞💝")
    await e.edit("SAYANG KAMU DIKIT AJA💞")
...
async def santet(client: Client, message: Message):
    typew = await edit_or_reply(message, "`Mengaktifkan Perintah Ngentod Online....`")
    await asyncio.sleep(2)
    await typew.edit("`Mencari Nama Orang Ini...`")
    await asyncio.sleep(1)
    await typew.edit("`Mengentod Online Segera Dilakukan`")
    await asyncio.sleep(1)
    await typew.edit("0%")
    number = 1
    ...
    await typew.edit(str(number) + "%   ████████████████▌")
    await asyncio.sleep(1)
    await typew.edit("**Target Berhasil Terkentod Online 🗿**")
