...
from Alvaren import *
from Alvaren.helpers.adminHelpers import DEVS, WHITELIST
from Alvaren.helpers.basic import edit_or_reply
from Alvaren.helpers.PyroHelpers import get_ub_chats
from Alvaren.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("Alvaren.helpers.SQL.gban_sql")
        sql2 = import_module("Alvaren.helpers.SQL.gmute_sql")
...
async def gmute_user(client: Client, message: Message):
    ...
    if user.id in WHITELIST:
        return await Man.edit(
            "**Gagal GMUTE karena dia adalah admin @nguyungg 🗿**"
        )
    try:
