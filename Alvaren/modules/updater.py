...
from Alvaren.helpers.misc import HAPP, XCB
from Alvaren.helpers.tools import get_arg
from Alvaren.utils.misc import restart
from Alvaren.utils.pastebin import PasteBin
from Alvaren.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        try:
            ...
            pass
        await status.edit(
            "`Alvaren-Userbot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
...
add_command_help(
    "update",
    [
        ["update", "Untuk melihat list pembaruan terbaru dari Alvaren-Userbot."],
